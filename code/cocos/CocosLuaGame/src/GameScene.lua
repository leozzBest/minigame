...
function GameScene:createLayerBack()
    ...
    button1:setPosition(cc.p(self.origin.x + self.visibleSize.width / 2 - 10, self.origin.y + self.visibleSize.height / 2 - 135))
    ...
    button2:setPosition(cc.p(self.origin.x + self.visibleSize.width / 2 - 10, self.origin.y + self.visibleSize.height / 2 - 275))
